...
const (
	...
	Review_AuditAppealReview_FullMethodName  = "/api.review.v1.Review/AuditAppealReview"
)
...
type ReviewClient interface {
	...
	// O端审核评价申诉
	AuditAppealReview(ctx context.Context, in *AuditAppealReviewRequest, opts ...grpc.CallOption) (*AuditAppealReviewReply, error)
}
...
func (c *reviewClient) AuditAppealReview(ctx context.Context, in *AuditAppealReviewRequest, opts ...grpc.CallOption) (*AuditAppealReviewReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuditAppealReviewReply)
	err := c.cc.Invoke(ctx, Review_AuditAppealReview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServer interface {
	...
	// O端审核评价申诉
	AuditAppealReview(context.Context, *AuditAppealReviewRequest) (*AuditAppealReviewReply, error)
...
func (UnimplementedReviewServer) AuditAppealReview(context.Context, *AuditAppealReviewRequest) (*AuditAppealReviewReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AuditAppealReview not implemented")
}
...
func _Review_AuditAppealReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuditAppealReviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).AuditAppealReview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_AuditAppealReview_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).AuditAppealReview(ctx, req.(*AuditAppealReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuditAppealReview",
			Handler:    _Review_AuditAppealReview_Handler,
		},
	},

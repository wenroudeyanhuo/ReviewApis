...
// Validate checks the field values on AuditAppealReviewRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AuditAppealReviewRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AuditAppealReviewRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AuditAppealReviewRequestMultiError, or nil if none found.
func (m *AuditAppealReviewRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AuditAppealReviewRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AuditAppealReviewRequestMultiError(errors)
	}

	return nil
}

// AuditAppealReviewRequestMultiError is an error wrapping multiple validation
// errors returned by AuditAppealReviewRequest.ValidateAll() if the designated
// constraints aren't met.
type AuditAppealReviewRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AuditAppealReviewRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AuditAppealReviewRequestMultiError) AllErrors() []error { return m }

// AuditAppealReviewRequestValidationError is the validation error returned by
// AuditAppealReviewRequest.Validate if the designated constraints aren't met.
type AuditAppealReviewRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AuditAppealReviewRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AuditAppealReviewRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AuditAppealReviewRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AuditAppealReviewRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AuditAppealReviewRequestValidationError) ErrorName() string {
	return "AuditAppealReviewRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AuditAppealReviewRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAuditAppealReviewRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AuditAppealReviewRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AuditAppealReviewRequestValidationError{}

// Validate checks the field values on AuditAppealReviewReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AuditAppealReviewReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AuditAppealReviewReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AuditAppealReviewReplyMultiError, or nil if none found.
func (m *AuditAppealReviewReply) ValidateAll() error {
	return m.validate(true)
}

func (m *AuditAppealReviewReply) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// AuditAppealReviewReplyMultiError is an error wrapping multiple validation
// errors returned by AuditAppealReviewReply.ValidateAll() if the designated
// constraints aren't met.
type AuditAppealReviewReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AuditAppealReviewReplyMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AuditAppealReviewReplyMultiError) AllErrors() []error { return m }

// AuditAppealReviewReplyValidationError is the validation error returned by
// AuditAppealReviewReply.Validate if the designated constraints aren't met.
type AuditAppealReviewReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AuditAppealReviewReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AuditAppealReviewReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AuditAppealReviewReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AuditAppealReviewReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AuditAppealReviewReplyValidationError) ErrorName() string {
	return "AuditAppealReviewReplyValidationError"
}

// Error satisfies the builtin error interface
func (e AuditAppealReviewReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAuditAppealReviewReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AuditAppealReviewReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AuditAppealReviewReplyValidationError{}

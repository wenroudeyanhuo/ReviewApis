...
func (x *AuditAppealReviewReply) GetReviewID() int64 {
	if x != nil {
		return x.ReviewID
	}
	return 0
...
const file_review_v1_review_proto_rawDesc = "" +
	"\n" +
	"\x16review/v1/review.proto\x12\rapi.review.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xda\x02\n" +
	...
	"\breviewID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\breviewID\"4\n" +
	"\x16AuditAppealReviewReply\x12\x1a\n" +
